...
public class UltimaJugadaBean implements Serializable{
	...
	public UltimaJugadaBean(int idsorteo, String numero01, String numero02, String numero03, String numero04,
			String numero05, String numero06) {
		super();
